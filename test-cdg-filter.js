// Test filtro file .cdg

const testCases = [
  { input: "SF025-12 - David Bowie - China Girl.cdg", type: "cdg" },
  { input: "ABC-123 - Beatles - Yesterday.cdg", type: "cdg" },
...
console.log("🧪 Test filtri .cdg vs .mkf/.dbk:\n");
...
testCases.forEach((test, index) => {
  ...
  // Rimuovi codice iniziale per file .cdg
  rawText = rawText.replace(/^[A-Z0-9]+-\d{1,3}\s*-\s*/i, '').trim();
